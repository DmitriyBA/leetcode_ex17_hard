...
def sudoku_solver_block(map_for_solver: list, dict_input: dict) -> list:
    """
    Функция принимает на вход карту судоку и словарь в котором содержатся 2 списка:
    1. Список из цифр строки
    2. Список из цифр колонки
    возвращает список из цифр блока для сравнения и добавляет его в словарь
    """
    pass
...
if __name__ == "__main__":
    sudoku_solver_block(main())
    sudoku_solver_column_row(main())